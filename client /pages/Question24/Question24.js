...
function Question24 (){
  ...
  const second41 = (e) => {
    e.preventDefault();
    Axios.post("http://localhost:3001/second41", {
   heading: heading,
...
<br/>
   ...
   <div className="loginForm">
        <form>
          ...
          <h4>Question 2</h4>
          <br/>
          <div  className="cnav"><a href="/question34" className="btn btn-secondary ">New Question</a>
...
<ReactQuill theme="snow"  value={answer1} onChange= {setAnswer1} placeholder="Enter Answer"  />
    ...
    <ReactQuill theme="snow" value={map1} onChange={setMap1} placeholder="Map Outcome" />         
          ...
          <br/>
          <input className=".btn-btn btn-primary" type="submit" onClick={second41} value="Create Question page" />
