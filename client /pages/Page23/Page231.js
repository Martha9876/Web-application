...
<div class="form-control">
            ...
            < input type="radio" name="answer"
              ...
              id="answer1" 
              onClick={() => setScore(score7+1)}/>
              <label for ="answer1">            <div dangerouslySetInnerHTML={{__html:item.answer2}}/>
       </label>
...
<input type="radio" 
              ...
              id="answer2" 
              onClick={() => setScore(score7-1)}
           />     <label for ="answer2">  <div dangerouslySetInnerHTML={{__html:item.answer3}}/>
        </label>
        </div>
...
<input type="radio" 
              ...
              id="answer2" 
              onClick={() => setScore(score7-1)}
           />     <label for ="answer2">  <div dangerouslySetInnerHTML={{__html:item.answer4}}/>
        </label>
        <br/>
        <br/>
        <br/>
