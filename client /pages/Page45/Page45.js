...
const Page45 = () => {
  ...
  const fetchData = async () => {
    const response=await axios.get(`http://localhost:3001/getdata45`)
...
<h1 className="Heading"> Question 5 </h1>
            <div className="row">
   ...
   <label className="form-control">
       ...
       <span2 className="option"></span2>
        ...
        <span21>  <a href="/result" className="btn btn-primary "  onClick={() => this.handleNext()}>Next</a>
        </span21>
