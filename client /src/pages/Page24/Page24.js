...
<h1  className="question"  > Question 4 </h1>
          ...
          <div key={item}>
           ...
           <label className="form-control">
            ...
            onChange={onAnswerSelected} onClick={() => setCounter(counter + 3)}/>     <div dangerouslySetInnerHTML={{__html:item.answer1}}/>
...
<a href="/page25" className="btn btn-primary "  onClick={() => this.handleNext()}>Next</a>
