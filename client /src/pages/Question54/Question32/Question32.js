...
function Question32 (){
  ...
  const second2 = (e) => {
    e.preventDefault();
    Axios.post("http://localhost:3001/second22", {
      heading: heading,
    ...
    return(<Fragment>
       <div>
                ...
                <button  className="button-urls" onClick={setUrl} >Publish Url</button>
                    {
                      url &&(<p>http://localhost:3000/page23233</p>)
                    }
                      <br/>
                      <br/>  
                </div>
...
<br/>
   ...
   <div className="loginForm">
        <form>
          ...
          <h4>Question 3</h4>
          <br/>
          <div  className="cnav"><a href="/question42" className="btn btn-secondary ">New Question</a>
