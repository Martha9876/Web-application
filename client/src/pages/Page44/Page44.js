...
const Page44 = () => {
  ...
  const fetchData = async () => {
    const response=await axios.get(`http://localhost:3001/getdata44`)
...
<h1 className="Heading"> Question 4 </h1>
            <div className="row">
   ...
   <label className="form-control">
       ...
       <span2 className="option"></span2>
        ...
        <span21>  <a href="/page45" className="btn btn-primary "  onClick={() => this.handleNext()}>Next</a>
        </span21>
