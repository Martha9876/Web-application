    ...
    
{
 ...
 <div dangerouslySetInnerHTML={{__html:item.map1}}/>
        ...
        <div>
          ...
          <p>Share</p>
          <a href="https://twitter.com/share?url=<http://localhost:3000/result/1>" target="_blank"><i className="fab fa-twitter"></i>  </a>
          <a href="https://www.instagram.com/sharer/?u=http://localhost:3000/result/1" target="_blank"><i className="fab fa-instagram"></i>  </a>
          <h1> Print </h1> 
          <span29>   <a href = "https://amber-alleen-3.tiiny.site" download> 
