...
function Question34 (){
  ...
  const second42 = (e) => {
    e.preventDefault();
    Axios.post("http://localhost:3001/second42", {
      heading: heading,
...
<div>
                ...
                <br/>
                <button  className="button-urls"onClick={()=>setUrl(!url)} >Publish Url</button>
                    {
...
<br/>
   ...
   <div className="loginForm">
        <form>
          ...
          <h4>Question 3</h4>
          <br/>
          <div  className="cnav"><a href="/question44" className="btn btn-secondary ">New Question</a>
...
<option value="/question32">2</option>
<option value="/question34">4</option>
